...
public class PlayerTest {
    ...
    /**
     * Tests whether the property is
     * correctly mortgaged by the player.
     * Also checks that the player cannot
     * mortgage a property if they do not
    ...
    public void mortgageProperty() {
        ...
        assertEquals(balance - crapperStreet.getCost() / 2, one.getBalance());
        assertEquals(crapperStreet.getOwnedBy(), one);
     ...
     * pays off the mortgage of a property.
     * The player cannot pay the mortgage
     * if they do not enough money in their
     * balance.
     */
    @Test
