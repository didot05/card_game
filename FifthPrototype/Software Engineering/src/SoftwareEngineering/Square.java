...
public class Square {
    ...
    /**
     * Returns the selling price of the
     * square when there are no houses
     * or hotels on the property
     *
     * @return int
     */
    ...
    /**
     * Sets the mortgaged field of the square to
     * tbe specified boolean value
     *
     * @param mortgaged if the square is mortgaged
     */
    ...
    /**
     * Returns true if the square is mortgaged,
     * false otherwise.
     *
     * @return boolean
     */
