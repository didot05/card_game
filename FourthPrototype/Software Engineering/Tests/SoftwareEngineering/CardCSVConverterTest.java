...
public class CardCSVConverterTest {
    ...
    public void potLuck() {
        ...
        assertEquals("Collect £100", first.getAction());
    ...
    public void opportunityKnocks() {
        ...
        assertEquals("Repair £40/house £115/hotel", ninth.getAction());
        Card ten = oppurtunityKnocks.getPack().get(9);
        assertEquals("Advance to GO", ten.getDescription());
        assertEquals("Move to Go", ten.getAction());
        ...
        assertEquals("Repair £25/house £100/hotel", eleven.getAction());
        Card twelve = oppurtunityKnocks.getPack().get(11);
        assertEquals("Go back 3 spaces", twelve.getDescription());
        assertEquals("Back 3 spaces", twelve.getAction());
        ...
        assertEquals("Move to Skywalker Drive", thirteen.getAction());
