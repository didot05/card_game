        ...
        if (payingRent) {
            if (currentPlayer.getBalance() >= rentToPay) {
                if (owedPlayer != null) {
                    ...
                    controller.addToGameLog("Player " + currentPlayer.getId() + " has paid a rent of £" + rentToPay + " to Player " + owedPlayer.getId());
                } else {
                    currentPlayer.payBank(rentToPay);
                    controller.addToGameLog("Player " + currentPlayer.getId() + " has paid £" + rentToPay + " to the bank.");
                }
                payingRent = false;
                owedPlayer = null;
